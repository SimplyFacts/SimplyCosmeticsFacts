 ...
 */
export function handleToggleExpand(storeId, id) {
 ...
 */
export function expandAll(storeId) {
  const treeViewStore = getTreeViewStore(storeId);
  const {
    nodeMap,
    updateExpanded
 ...
 */
export function collapseAll(storeId) {
  const treeViewStore = getTreeViewStore(storeId);
  const {
    updateExpanded
  } = treeViewStore.getState();
 ...
 */
export function collapseNodes(storeId, ids) {
  const treeViewStore = getTreeViewStore(storeId);
  const {
    expanded,
    updateExpanded,
