...
exports.computeContentTransformGeometry = computeContentTransformGeometry;
exports.computeRelativeGeometry = computeRelativeGeometry;
/**
 * Get the anchor point coordinates for a given bound
 */
function getAnchorPoint(bounds, anchor = "center") {
  "worklet";
 ...
 */
function computeRelativeGeometry({
  start,
  end,
  entering,
  anchor = "center",
 ...
 */
function computeContentTransformGeometry({
  start,
  end,
  entering,
  dimensions,
