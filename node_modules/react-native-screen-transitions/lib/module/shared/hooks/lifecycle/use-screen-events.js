 ...
 */
export function useScreenEvents(current, previous, animations) {
  ...
  useAnimatedReaction(() => animations.closing.get(), (closing, prevClosing) => {
