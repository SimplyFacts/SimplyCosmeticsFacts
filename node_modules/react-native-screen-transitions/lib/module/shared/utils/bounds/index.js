...
export const createBounds = props => {
  "worklet";
  ...
  const interpolateBounds = (tag, property, fallbackOrTargetKey, fallback) => {
    ...
    if (typeof fallbackOrTargetKey === "string") {
      ...
      const fb = fallback ?? 0;
      const currentSnapshot = currentKey ? BoundStore.getSnapshot(tag, currentKey) : null;
      ...
      return interpolate(props.progress, range, [targetValue, currentValue], "clamp");
    }
