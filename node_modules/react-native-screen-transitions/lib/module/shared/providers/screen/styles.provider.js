...
const ScreenStylesContext = /*#__PURE__*/createContext(null);
export function ScreenStylesProvider({
  children
}) {
  ...
  return /*#__PURE__*/_jsx(ScreenStylesContext.Provider, {
    value: value,
    children: children
  });
}
